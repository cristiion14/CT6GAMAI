...
public class SimplifiedGrid : MonoBehaviour
{
    ...
    SimplifiedNode[,] NodeArray;//The array of nodes that the A Star algorithm uses.
    public List<SimplifiedNode> FinalPath;//The completed path that the red line will be drawn along
    ...
    public SimplifiedNode NodeFromWorldPoint(Vector3 a_vWorldPos)
    {
